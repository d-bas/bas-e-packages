...
```typescript
import { capitalize, slugify } from '@bas-e/strings';
...
Attempting to import from `@bas-e/colors` or `@bas-e/async` will result in a linting error due to module boundary constraints.