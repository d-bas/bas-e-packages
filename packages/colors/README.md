...
```typescript
import { hexToRgb, rgbToHex, lighten, darken } from '@bas-e/colors';
...
Attempting to import from `@bas-e/strings` or `@bas-e/async` will result in a linting error due to module boundary constraints.
